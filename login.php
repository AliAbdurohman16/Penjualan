...
<html lang="en">
  <head>
    ...
    <title>Login | Toko Oleh-Oleh Karya Indah</title>
      ...
      <div class="container">
        ...
        <div class="collpase navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a href="login-driver.php" class="nav-link">Login Gudang</a>
            </li>
          </ul>
        </div>
      </div>
        ...
        <div class="container">
          <div class="row align-items-center row-login">
            <div class="col-lg-6 text-center">
              <img
                src="assets/images/kilogo.png"
                alt=""
                class="w-50 mb-lg-none"
              />
            </div>
            <div class="col-lg-5">
              <h2 class="mb-4">Belanja makanan khas Kuningan menjadi lebih mudah</h2>
    ...
    <footer>
      <div class="container">
        <div class="row">
          <div class="col-12">
            <p class="pt-4 pb-2">
              2022 Copyright by Karya Indah. All Rights Reserved.
            </p>
          </div>
        </div>
      </div>
